...
export const INITIAL_STAGES: Record<string, StageData> = {
      ...
      items: [
        {
          ...
          statusLabel: 'Sắp tới',
          dateAchieved: null,
          note: 'Bé tự lật sấp và ngẩng cao đầu 90 độ vững vàng.',
        },
        {
          id: 'sit',
        ...
        },
        {
          ...
          statusLabel: 'Sắp tới',
          dateAchieved: null,
          note: 'Bé biết nhổm mông và đẩy người tiến lên phía trước.',
        },
        {
          id: 'stand_walk',
  ...
  stage_6_12: {
    ...
    motorMilestones: {
      ...
      items: [
        {
          id: 'bike',
          name: 'Đi xe đạp 2 bánh & Bơi lội',
          ageWindow: '6 - 8 tuổi',
          icon: '🚴',
          status: 'upcoming',
          statusLabel: 'Sắp tới',
          dateAchieved: null,
          note: 'Phối hợp tay chân nhịp nhàng, thể lực dẻo dai.',
        },
        {
          id: 'write',
          name: 'Viết chữ nét đều & Tư thế ngồi',
          ageWindow: '6 - 7 tuổi',
          icon: '✍️',
          status: 'upcoming',
          statusLabel: 'Sắp tới',
          dateAchieved: null,
          note: 'Ngồi thẳng lưng, cầm bút đúng cách chống gù vẹo.',
        },
        {
          id: 'sport',
          name: 'Chơi thể thao đồng đội (Bóng đá/Bóng rổ)',
          ageWindow: '7 - 10 tuổi',
          icon: '⚽',
          status: 'upcoming',
          statusLabel: 'Sắp tới',
          dateAchieved: null,
          note: 'Tăng chiều cao vượt trội, học tinh thần đồng đội.',
        },
      ],
    },
    expenses: {
  ...
  stage_13_18: {
    ...
    growthChart: {
      ...
      height: {
        child: [null, null, null, null, null, null],
        whoP50: [156.2, 163.8, 170.1, 173.4, 175.2, 176.1],
        whoP97: [168.0, 176.0, 182.0, 185.0, 187.0, 188.0],
        whoP3: [144.0, 151.0, 157.0, 161.0, 163.0, 164.0],
      },
      weight: {
        child: [null, null, null, null, null, null],
        whoP50: [45.8, 51.5, 56.8, 60.8, 64.0, 66.5],
        whoP97: [66.0, 73.0, 79.0, 84.0, 88.0, 91.0],
        whoP3: [33.0, 37.5, 42.0, 45.5, 48.0, 50.0],
      },
      headCirc: {
        child: [null, null, null, null, null, null],
        whoP50: [54.0, 54.6, 55.1, 55.5, 55.8, 56.0],
        whoP97: [56.4, 57.0, 57.5, 57.9, 58.2, 58.5],
        whoP3: [51.6, 52.2, 52.7, 53.1, 53.4, 53.6],
      },
    },
    growthHistory: [],
    motorMilestones: {
      ...
      items: [
        {
          id: 'growth_spurt',
          name: 'Bứt phá chiều cao dậy thì (Peak Spurt)',
          ageWindow: '13 - 15 tuổi',
          icon: '⚡',
          status: 'upcoming',
          statusLabel: 'Sắp tới',
          dateAchieved: null,
          note: 'Giai đoạn vàng tăng 8-12cm/năm nếu đủ dinh dưỡng và giấc ngủ.',
        },
        {
          id: 'fitness',
          name: 'Thể lực dẻo dai & Sức bền',
          ageWindow: '14 - 18 tuổi',
          icon: '🏋️',
          status: 'upcoming',
          statusLabel: 'Sắp tới',
          dateAchieved: null,
          note: 'Duy trì tập thể dục ít nhất 60 phút mỗi ngày.',
        },
      ],
    },
    expenses: {
...
export const AI_CHAT_KNOWLEDGE: AIChatKnowledge = {
  doctorName: 'Trợ lý AI Haven về chăm sóc Bé & Mẹ',
  status: 'Sẵn sàng hỗ trợ',
  suggestedQuestions: [
    'Bé sau tiêm 6in1 có thể gặp những phản ứng nào?',
    'Thực đơn ăn dặm giàu sắt và kẽm cho bé?',
    'Làm sao tập cho bé nhịp ngủ đều đặn?',
    'Bí quyết duy trì nguồn sữa mẹ dồi dào?',
  ],
  mockReplies: {
    sot: 'Chào Ba/Mẹ! Với mức sốt nhẹ sau tiêm chủng, đây thường là phản ứng tạo miễn dịch bình thường. Mẹ hãy: 1. Cho bé mặc thoáng mát. 2. Lau ấm (36-37°C) ở nách, bẹn. 3. Tăng cữ bú. 4. Tham khảo ý kiến bác sĩ hoặc cho uống hạ sốt nếu sốt từ 38.5°C trở lên theo đúng liều lượng cân nặng.',
    an_dam: 'Thực đơn ăn dặm cần ưu tiên đa dạng 4 nhóm chất: Tinh bột, đạm (thịt, cá, trứng), chất béo tốt và rau củ quả giàu vitamin/khoáng chất. Kết hợp thực phẩm giàu Vitamin C để tăng hấp thu sắt tự nhiên.',
    ngu: 'Để rèn nếp ngủ cho bé: 1. Tạo thói quen trước khi ngủ nhất quán (vệ sinh ấm, đọc sách, tắt đèn). 2. Đảm bảo phòng ngủ yên tĩnh, nhiệt độ mát mẻ (22-24°C). 3. Nhận biết sớm các dấu hiệu buồn ngủ của bé.',
    chieu_cao: 'Để con phát triển chiều cao tối ưu: 1. Đảm bảo giấc ngủ sâu từ 22h - 02h sáng (thời điểm hormone tăng trưởng GH tiết nhiều nhất). 2. Bổ sung đầy đủ D3, Canxi từ dinh dưỡng tự nhiên. 3. Khuyến khích bé vận động ngoài trời.',
  },
};

        ...
        <div className="growth-history-cards-list">
          {history.map((record) => (
            <div key={record.id} className="history-record-card">
              <div className="history-card-top"><div>{record.ageText && <span className="history-age-text">{record.ageText}</span>}<span className="history-date-text">{record.date}</span></div></div>
